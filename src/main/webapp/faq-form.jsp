			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Category</label> <input type="text"
						value="<c:out value='${faq.category}' />" class="form-control"
						name="category" required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Problem</label> <input type="text"
						value="<c:out value='${faq.problem}' />" class="form-control"
						name="problem">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Solution</label> <textarea name="solution" class="form-control">
						<c:out value='${faq.solution}' /> 
						</textarea>
				</fieldset>
				
				<fieldset class="form-group">
					<label>Author</label> <input type="text"
						value="<c:out value='${faq.author}' />" class="form-control"
						name="author">
				</fieldset>
